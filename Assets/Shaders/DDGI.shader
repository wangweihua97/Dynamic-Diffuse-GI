            ...
            float4 frag(Varings IN):SV_Target
            {
                ...
                for (int i = 0; i < 8; ++i) {
                    ...
                    // Moment visibility test
                    {
                        ...
                        float2 temp = SAMPLE_TEXTURE2D(irradianceMeanMeanSquared, sampler_BaseMap, texCoord).rg;
                        float mean = temp.x;
                    ...
                    Irradiance3 probeIrradiance = SAMPLE_TEXTURE2D(irradianceMap ,sampler_BaseMap ,texCoord).rgb;
